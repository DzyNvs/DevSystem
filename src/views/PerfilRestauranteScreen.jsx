      ...
      >
        ...
        <View style={styles.card}>
          ...
          <View style={styles.imageUploadContainer}>
            <TouchableOpacity
              style={[styles.boxLogo, ctrl.erros.logo && styles.inputErro]}
              onPress={() => escolherImagem("logo")}
            >
              {ctrl.logo ? (
                <Image
                  source={{ uri: ctrl.logo }}
                ...
                <Ionicons
                  name="camera-outline"
                  size={32}
                  color={ctrl.erros.logo ? "#E53E3E" : "#A0A0A0"}
                />
              )}
            </TouchableOpacity>
          ...
          {ctrl.erros.logo && (
            <Text style={styles.textoErro}>{ctrl.erros.logo}</Text>
          )}
        ...
        <View style={styles.card}>
          ...
          <TextInput
            ...
            onChangeText={(texto) => {
              ctrl.setNomeFantasia(texto);
              ctrl.setErros((prev) => ({ ...prev, nomeFantasia: null }));
            }}
            placeholder="Nome da sua loja"
          />
          {ctrl.erros.nomeFantasia && (
            <Text style={styles.textoErro}>{ctrl.erros.nomeFantasia}</Text>
          )}
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    ctrl.erros.especialidade && styles.chipErro,
                  ]}
                  onPress={() => {
                    ctrl.setEspecialidade(cat);
                    ctrl.setErros((prev) => ({ ...prev, especialidade: null }));
                  }}
                >
                  <Text
                    style={[
          ...
          {ctrl.erros.especialidade && (
            <Text style={styles.textoErro}>{ctrl.erros.especialidade}</Text>
          )}
          ...
          <TextInput
            style={styles.input}
            value={ctrl.taxaEntrega}
            onChangeText={ctrl.setTaxaEntrega}
        ...
        <View style={styles.card}>
          ...
          />
          {ctrl.erros.cep && (
            <Text style={styles.textoErro}>{ctrl.erros.cep}</Text>
          )}

          <Text style={styles.label}>Rua / Avenida *</Text>
          <TextInput
            style={[styles.input, ctrl.erros.rua && styles.inputErro]}
            value={ctrl.endereco.rua}
            onChangeText={(texto) => ctrl.handleEnderecoChange("rua", texto)}
          ...
          <View style={styles.linhaDupla}>
            <View style={styles.metade}>
              ...
              <TextInput
                style={[styles.input, ctrl.erros.numero && styles.inputErro]}
                value={ctrl.endereco.numero}
                onChangeText={(texto) =>
                  ctrl.handleEnderecoChange("numero", texto)
                }
                placeholder="Ex: 1000"
                keyboardType="numeric"
              />
            ...
            <View style={styles.metade}>
              ...
              <TextInput
                ...
                onChangeText={(texto) =>
                  ctrl.handleEnderecoChange("complemento", texto)
                }
                placeholder="Loja 2"
              />
            </View>
          ...
          <TextInput
            style={[styles.input, ctrl.erros.bairro && styles.inputErro]}
            value={ctrl.endereco.bairro}
            onChangeText={(texto) => ctrl.handleEnderecoChange("bairro", texto)}
            placeholder="Bairro"
          />
          ...
          <View style={styles.linhaDupla}>
            <View style={[styles.metade, { flex: 2, marginRight: 10 }]}>
              ...
              <TextInput
                style={[styles.input, ctrl.erros.cidade && styles.inputErro]}
                value={ctrl.endereco.cidade}
                onChangeText={(texto) =>
                  ctrl.handleEnderecoChange("cidade", texto)
                }
                placeholder="Cidade"
              />
            </View>
            <View style={[styles.metade, { flex: 1 }]}>
              ...
              <TextInput
                style={[styles.input, ctrl.erros.estado && styles.inputErro]}
                value={ctrl.endereco.estado}
                onChangeText={(texto) =>
                  ctrl.handleEnderecoChange("estado", texto)
                }
                placeholder="SP"
                maxLength={2}
        ...
        <View style={styles.card}>
          ...
          {ctrl.erros.pagamentos && (
            <Text style={styles.textoErro}>{ctrl.erros.pagamentos}</Text>
          )}
          <View style={styles.gridPagamentos}>
            {Object.keys(ctrl.pagamentos).map((chave) => (
              <TouchableOpacity
                ...
                onPress={() => ctrl.togglePagamento(chave)}
              >
                <Ionicons
                  name={ctrl.pagamentos[chave] ? "checkbox" : "square-outline"}
                  size={24}
                  color={ctrl.pagamentos[chave] ? "#93BD57" : "#A0A0A0"}
                />
        ...
        <View style={styles.card}>
          ...
          {ctrl.erros.horarios && (
            <Text style={styles.textoErro}>{ctrl.erros.horarios}</Text>
          )}
          {nomesDias.map((dia) => (
            <View key={dia} style={styles.itemDia}>
              <View style={styles.linhaDiaTopo}>
                ...
                <Switch
                  ...
                  thumbColor={
                    ctrl.horarios[dia].funciona ? "#93BD57" : "#f4f3f4"
                  }
                ...
                <View style={styles.linhaHoras}>
                  <View style={styles.colunaHora}>
                    ...
                    <TextInput
                      ...
                      value={ctrl.horarios[dia].abertura}
                      onChangeText={(texto) =>
                        ctrl.handleHoraChange(dia, "abertura", texto)
                      }
                      keyboardType="numeric"
                      maxLength={5}
                    />
                  ...
                  <View style={styles.colunaHora}>
                    ...
                    <TextInput
                      style={styles.inputHora}
                      value={ctrl.horarios[dia].fechamento}
                      onChangeText={(texto) =>
                        ctrl.handleHoraChange(dia, "fechamento", texto)
                      }
                      keyboardType="numeric"
                      maxLength={5}
                    />
        ...
        <TouchableOpacity
          style={[
            styles.botao,
            ctrl.salvando && { backgroundColor: "#c5e1a5" },
          ]}
          onPress={ctrl.handleSalvar}
