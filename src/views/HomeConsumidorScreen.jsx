          ...
          <View style={styles.footerColumnsRow}>
            <View style={styles.footerBrandCol}>
              ...
              <Text style={styles.footerBrandText}>
                O seu delivery de comida saudável. Descubra refeições nutritivas perto de você.
              </Text>
            </View>
            ...
            <View style={styles.footerColumn}>
              ...
              <View style={styles.footerLinksList}>
                ...
                {/* LINK "COMO FUNCIONA" ADICIONADO AQUI */}
            ...
            <View style={styles.footerColumn}>
              ...
              <View style={styles.socialRow}>
                ...
                <TouchableOpacity onPress={() => router.push('/contatos')}><Image source={igIcon} style={styles.socialIconFooter} /></TouchableOpacity>
                <TouchableOpacity onPress={() => router.push('/contatos')}><Image source={xIcon} style={styles.socialIconFooter} /></TouchableOpacity>
              </View>
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontSize: 36, fontWeight: 'bold', color: '#FFF', textAlign: 'center' },
  heroSubtitle: { fontSize: 18, color: '#FFF', marginTop: 10, marginBottom: 30 },
  ...
  sectionTitle: { fontSize: 22, fontWeight: 'bold', color: '#2E7D32', marginVertical: 30, textAlign: 'center' },
  ...
  footerTitle: { fontSize: 20, fontWeight: '700', color: '#000', marginBottom: 20 },
  socialTitle: { color: '#000', fontSize: 20, fontWeight: '700', marginBottom: 20 },
  footerLinksList: { gap: 15 },
  footerLinkItem: { fontSize: 16, color: '#000' },
