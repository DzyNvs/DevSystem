      ...
      {ctrl.alerta.mostrar && (
        <View style={styles.toastContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={ctrl.irParaMeusPedidos}
          >
            <Text style={styles.toastButtonText}>Acompanhar</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={ctrl.fecharAlerta}
      ...
      <View style={styles.headerContainer}>
        ...
        <View style={styles.leftSection}>
          ...
          <View style={styles.navLinks}>
            ...
            <TouchableOpacity
              onPress={() => router.push("/home-consumidor-screen")}
            >
              <Text
                style={[
                  styles.navText,
                  pathname === "/home-consumidor-screen" &&
        ...
        <View style={styles.rightSection}>
          {/* ── DROPDOWN DE ENDEREÇO MANTIDO DA BRANCH DEVELOP ── */}
          <View style={{ position: "relative", zIndex: 1000 }} ref={dropRef}>
            ...
            >
              ...
              <Ionicons
                name={
                  endDropOpen ? "chevron-up-outline" : "chevron-down-outline"
                }
                size={14}
                color="#93BD57"
                style={{ marginLeft: 6 }}
            ...
            {endDropOpen && (
              <View style={styles.endDrop}>
                ...
                {enderecos.length === 0 && (
                  <Text style={styles.endDropVazio}>
                    ...
                    return (
                      ...
                      >
                        <View
                          style={[
                            styles.endDropIcon,
                            ativo && styles.endDropIconAtivo,
                          ]}
                        >
                          <Ionicons
                            name={getIcone(end.apelido)}
                            size={16}
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    setEndDropOpen(false);
                    router.push("/selecionar-endereco");
                  }}
                >
                  <Ionicons name="list-outline" size={16} color="#555" />
                  <Text style={styles.endDropAcaoTexto}>
                    Gerenciar endereços
                  </Text>
                </TouchableOpacity>
                ...
                >
                  ...
                  <Text
                    style={[
                      styles.endDropAcaoTexto,
                      { color: "#93BD57", fontWeight: "700" },
                    ]}
                  >
          ...
          <View style={{ position: "relative", zIndex: 999 }}>
            <TouchableOpacity
              ...
              onPress={() => ctrl.setMenuAberto(!ctrl.menuAberto)}
            >
            ...
            {ctrl.menuAberto && (
              <View style={styles.dropdownMenu}>
                ...
                >
                  ...
                  <Text style={[styles.dropdownText, { color: "#005F02" }]}>
                    Meus Pedidos
                  </Text>
                </TouchableOpacity>
...
// Estilos unificados (removidas as duplicações do final do arquivo conflitante)
